...
export function EditCategoryDialog({
  ...
  const [categoryData, setCategoryData] = useState<CategoryData>(category);
  ...
  const handleEditCategory = async () => {
    try {
      const response = await axios.put(
        `${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/category/${categoryData._id}`,
        categoryData,
        {
          headers: {
      ...
      const updatedCategories = categories.map((cat) =>
        cat._id === categoryData._id ? response.data.data : cat
      );
